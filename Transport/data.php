...
TABEL DATA TRANSPORTASI DISPORA JATIM
</div>
	...
	<tbody>
		<?php
			...
			$queryview = mysqli_query($koneksi, "SELECT t.no_tiket, t.nama_kendaraan, t.no_penerbangan, t.no_kursi, d.nama_daerah FROM transportasi t
						join akomodasi a on t.no_tiket = a.no_tiket join daerah d on a.kode_daerah = d.kode_daerah");
			...
			<td><?php echo $row['nama_daerah'];?></td>
			 <td>
            	<div class="action-buttons">
					<a class="red" href="#">
						<a href="Transport/pdf.php?id=<?php echo $row['no_tiket']; ?>" id="exportpdftransport" target="_blank"><i class="ace-icon fa fa-file-pdf-o bigger-130"></i></a>
					</a>
					<a class="red" href="#">
						<a href="Transport/word.php?id=<?php echo $row['no_tiket']; ?>" id="exportwordtransport" target="_blank"><i class="ace-icon fa fa-file-word-o bigger-130"></i></a>
					</a>
				</div>
            </td>
		</tr>
