		...
		<script src="Transportasi/crud_transportasi.js"></script>

					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								<i class="ace-icon fa fa-home home-icon"></i>
								D.Master Transportasi
							</li>
							<li class="active">Data Jenis Transportasi</li>
						</ul><!-- /.breadcrumb -->
										            ...
										            <div class="modal-dialog"> 
										              <div class="modal-content">
										                <div class="modal-header">
										                  ...
										                  <h3 class="modal-title">Tambah Data Jabatan Baru</h3>
										                </div>
										                <div class="modal-body">
										                  <form role="form" id="form-tambah" method="post" action="input.php">
										                    <div class="form-group">
										                      ...
										                      <div class="col-sm-8"><input type="text" class="form-control" name="kode_transportasi" id="kode_transportasi" placeholder="Kode Transportasi" value="" autocomplete="off">  
										                      </div> 
										                      </div>
										                    </div>
										                    <div class="form-group">
										                    ...
										                    <div class="form-group">
										                      ...
										                      <div class="col-sm-8"><input type="text" class="form-control" name="jenis_transportasi" id="jenis_transportasi" placeholder="Nama Jabatan" value="" autocomplete="off">  		
										                      </div>
										                      </div>
										                    </div>
										                    <div class="form-group">
										                  		<div class="row">
										                      	<div class="col-sm-12">
										                      		<p style="color:red;text-align: center;" id="error_jenis"></p>
										                      	</div>
										                      </div>
										                    </div>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-header">
															...
															<h4 class="modal-title">DATA JENIS TRANSPORTASI</h4>
														</div>
															<div class="modal-body">
																<div id="data-edit">
